...
if(isset($_POST["submit"])) { // Vérifie l'existence de la clé "submit" dans le tableau $_POST
    ...
    $price = filter_input(INPUT_POST, "price", FILTER_VALIDATE_FLOAT, FILTER_FLAG_ALLOW_THOUSAND); // Valide le prix si il s'agit d'un nombre à virgule, on y ajoute les drapeaux FILTER_FLAG_ALLOW_THOUSAND, pour permettre l'utilisation du caractère "," ou "." pour la décimale
